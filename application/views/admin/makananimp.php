   <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Import MAKANAN</li>
      </ol>
    </section>
...
<form action="<?php echo base_url();?>admin/makananct/importdata" method="post" enctype="multipart/form-data" name="csv" id="csv">
  <tr>
    <td height="30" bgcolor="#aacccc"><div align="center"><strong>IMPORT MAKANAN</strong></div></td>
  </tr>

  <tr>
    <td>&nbsp;Delimiter :
      <input name="delimiter" type="text" id="delimiter" value=";" size="1" maxlength="1" />
      <br> gunakan judul kolom : makanan,harga_makanan,tglupdate,opupdate
...
<?  if (($data = fgetcsv($handle, 1000, $delimiter)) !== FALSE) {
    $jumkol=count($data);
	$hasil=$this->makananmd->cekkolom($data);
	if (!$hasil[0])
	{
		echo $hasil[1];return;
	}else
...
//		if ($_REQUEST[header] == "1") {
		CSVImport("makanan", $judul, "csv",$delimiter,"1","idx", "0");
//		} else {
//		CSVImport("phonebook", $judul, "csv",$grupid,$delimiter,"0","0");
//		}
	} else {
//		if ($_REQUEST[header] == "1") {
		CSVImport("makanan", $judul, "csv",$delimiter,"1","idx","1");
//		} else {
