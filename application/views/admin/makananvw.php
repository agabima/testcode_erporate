...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <!-- /.box-header -->
       <form action="<?php echo site_url('admin/makananct')?>" method="post">
        <div class="box-body">
          <div class="row">
            <div class="col-md-3 col-sm-6">              
              <div class="form-group">
                ...
                <select name="field1" class="form-control">        
				  <option value="makanan" <?=($field1=="makanan" ? "selected" : "") ?> >makanan</option>
<option value="harga_makanan" <?=($field1=="harga_makanan" ? "selected" : "") ?> >harga_makanan</option>
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6">              
              <div class="form-group">
				...
				<option value="makanan" <?=($field2=="makanan" ? "selected" : "") ?> >makanan</option>
<option value="harga_makanan" <?=($field2=="harga_makanan" ? "selected" : "") ?> >harga_makanan</option>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <?php   
              if ($this->Usersinmd->ishakok($username,'tmak'))
                { ?>
              <button type="button" class="btn bg-navy margin" onclick="location.href='<?php echo site_url('admin/makananct/tambah');?>'">
                <i class="fa fa-fw fa-plus-square"></i> 
                  <b>Tambah MAKANAN</b>
              </button>
              <?php } ?>
              <button type="button" class="btn bg-olive margin" onclick="location.href='<?php echo site_url('admin/makananct/excel/0');?>'" target="_blank">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered table-bordered">
                <tr>
				<th>No</th>
								<th field="makanan">makanan</th>
				<th field="harga_makanan">harga_makanan</th>
...
<td><?=$hasil->opupdate?></td>
                    ...
                    <?php   
              if ($this->Usersinmd->ishakok($username,'umak'))
                { ?>
                  <a class="btn btn-default btn-sm" href="<?php echo base_url().'admin/makananct/ubah/'.$hasil->idx.'';?>"><i class="fa fa-pencil-square-o"></i></a>
                  <?php } ?>
              <?php   
              if ($this->Usersinmd->ishakok($username,'hmak'))
                { ?>
                  <a onclick="return konfirmasi()" class="btn btn-default btn-sm" href="<?php echo base_url().'admin/makananct/hapus/'.$hasil->idx.'';?>"><i class="fa fa-trash-o"></i></a>
              <?php } ?>
            ...
            <form action="<?=base_url().'admin/makananct'?>" name="fperpage" method="post"> <input type="text" name="perpage" value="<?=$perpage?>" size="2" onblur="fperpage.submit()"> per page
