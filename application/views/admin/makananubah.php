  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Ubah MAKANAN</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
    <form name="member" method="post" action="<?php echo base_url().'admin/makananct/proses_ubah/'.$member->idx.'';?>">     
...
<input name="makanan" class="form-control" type="text" id="makanan" value="<?php echo $member->makanan;?>" >
</div>
<div class="form-group"><label>harga_makanan</label>
<input name="harga_makanan" class="form-control" type="text" id="harga_makanan" value="<?php echo $member->harga_makanan;?>"  onKeyPress="return numeric_only(this, event)">
</div>
